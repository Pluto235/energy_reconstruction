...
REPORT_PATH = REPORT_DIR / "crab_sed_v6_64670_split56_baselinev4_report.html"
ASSET_DIR = REPORT_DIR / "assets" / "v6-64670-split56"
STAGE_B_FIT_SHADED_PROFILE = ASSET_DIR / "v6_64670_split56_stage_b_radial_psf_profiles_fit_shaded.png"

SELECTOR = REPO_ROOT / "apply/config/cell_selector_v6_split56_drop4_psfborrow.csv"
LEDGER = REPO_ROOT / "apply/config/cell_ledger_v6_split56_candidate.csv"
STAGE_A = REPO_ROOT / "apply/output/stage_a_v6_64670_split56"
STAGE_A_AP = REPO_ROOT / "apply/output/stage_a_v6_64670_split56_aperture_conditioned"
STAGE_B = REPO_ROOT / "apply/output/stage_b_v6_64670_split56/runs/v6_64670_split56_stage_b_psf"
STAGE_C = REPO_ROOT / "apply/output/stage_c_v6_64670_split56/runs/v6_64670_split56_stage_c_halfyear"
STAGE_D = REPO_ROOT / "apply/output/stage_d_v6_64670_split56_annnorm/runs/v6_64670_split56_stage_d_annnorm"
STAGE_E = REPO_ROOT / "apply/output/stage_e_v6_64670_split56_containment1_annnorm/runs/v6_64670_split56_stage_e_containment1_annnorm"
STAGE_F = REPO_ROOT / "apply/output/stage_f_v6_64670_split56_baselinev4/runs/v6_64670_split56_stage_f_baselinev4"
STAGE_G = REPO_ROOT / "apply/output/stage_g_v6_64670_split56_baselinev4/runs/v6_64670_split56_stage_g_baselinev4"
...
def ensure_stage_b_fit_shaded_profile_grid(fit_ids: set[int]) -> None:
    psf_path = STAGE_B / "psf_v6_64670_split56.npz"
...
def comparison_rows(v6_summary_csv: Path) -> list[list[str]]:
    v4_csv = V4_STAGE_G / "sed_points_v4_aperture_conditioned_drop4_summary.csv"
    if not v4_csv.exists():
        return []
    v6_rows = sed_rows_by_group(v6_summary_csv, "nhit")
    v4_rows = sed_rows_by_group(v4_csv, "nhit")
...
def main() -> None:
    stage_a_meta = load_json(STAGE_A / "response_2d_v6_64670_split56_metadata.json")
    stage_a_ap_meta = load_json(STAGE_A_AP / "response_2d_v6_64670_split56_aperture_conditioned_metadata.json")
    stage_b_meta = load_json(STAGE_B / "psf_v6_64670_split56_metadata.json")
    stage_c_meta = load_json(STAGE_C / "obs_events_metadata.json")
    stage_d_meta = load_json(STAGE_D / "background_v6_64670_split56_annnorm_metadata.json")
    stage_e_meta = load_json(STAGE_E / "signal_v6_64670_split56_containment1_annnorm_metadata.json")
    stage_f_meta = load_json(STAGE_F / "fit_v6_64670_split56_baselinev4_metadata.json")
    stage_g_meta = load_json(STAGE_G / "sed_points_v6_64670_split56_baselinev4_metadata.json")
    stage_g_summary = load_json(STAGE_G / "sed_points_v6_64670_split56_baselinev4_summary.json")
    ...
    f_rows = selected_fit_rows(load_csv(STAGE_F / "fit_v6_64670_split56_baselinev4_summary.csv"), fit_cell_ids)
    g_summary_csv = STAGE_G / "sed_points_v6_64670_split56_baselinev4_summary.csv"
    ...
    stage_rows = [
        ("Prepare split56 cache", "/mnt/mydisk/WCDA_simulation_binned_response_v6_64670_split56_candidate"),
        ("Stage A nominal response", "apply/output/stage_a_v6_64670_split56"),
        ("Stage B PSF", "apply/output/stage_b_v6_64670_split56"),
        ("Stage A aperture-conditioned response", "apply/output/stage_a_v6_64670_split56_aperture_conditioned"),
        ("Stage C observation reduction", "apply/output/stage_c_v6_64670_split56"),
        ("Stage D annulus-normalized background", "apply/output/stage_d_v6_64670_split56_annnorm"),
        ("Stage E signal", "apply/output/stage_e_v6_64670_split56_containment1_annnorm"),
        ("Stage F forward-folding fit", "apply/output/stage_f_v6_64670_split56_baselinev4"),
        ("Stage G diagnostic SED", "apply/output/stage_g_v6_64670_split56_baselinev4"),
    ]
    ...
    artifacts = [
        ...
        ("Stage A nominal metadata", STAGE_A / "response_2d_v6_64670_split56_metadata.json"),
        ("Stage B PSF NPZ", STAGE_B / "psf_v6_64670_split56.npz"),
        ("Stage A aperture response", STAGE_A_AP / "response_2d_v6_64670_split56_aperture_conditioned.npz"),
        ("Stage C metadata", STAGE_C / "obs_events_metadata.json"),
        ("Stage D background", STAGE_D / "background_v6_64670_split56_annnorm.npz"),
        ("Stage E signal", STAGE_E / "signal_v6_64670_split56_containment1_annnorm.npz"),
        ("Stage F fit", STAGE_F / "fit_v6_64670_split56_baselinev4.npz"),
        ("Stage G SED points", STAGE_G / "sed_points_v6_64670_split56_baselinev4.npz"),
        ("Stage E HTML", REPORT_DIR / "stage_e_v6_64670_split56_containment1_annnorm_report.html"),
        ("Stage F HTML", REPORT_DIR / "stage_f_v6_64670_split56_baselinev4_report.html"),
        ("Stage G HTML", REPORT_DIR / "stage_g_v6_64670_split56_baselinev4_report.html"),
    ]

    comparison = comparison_rows(g_summary_csv)
    comparison_section = (
        "<p>The v4 comparison is explicit reference-only; all main split56 paths above point to v6 split56 products.</p>"
        + table(["Nhit group", "split56 E_eff TeV", "split56 E2 dN/dE", "split56 err", "v4 E2 dN/dE", "v4 err", "split56/v4", "split56/full-array PL"], comparison)
        if comparison
        else "<p>v4 comparison table unavailable because the reference Stage G CSV was not found.</p>"
    )
...
<head>
  ...
  <title>Crab SED v6 _64670 split56 baselinev4 report</title>
  <style>
    :root {{
      --ink: #17202a;
      --muted: #5d6673;
...
<main>
  <header>
    <h1>Crab SED v6 <code>_64670</code> split56 baselinev4</h1>
    <p class="lede">This report reruns the v6 <code>_64670</code> baselinev4 apply chain with the final physical predE bin split from <code>[5,6)</code> into <code>[5,5.5)</code> and <code>[5.5,6)</code>. Nhit bins are unchanged, <code>&gt;=6</code> remains in the candidate cache, and fit-cell selection is frozen by <code>(nhit_bin,predE_bin)</code> mapping rather than old cell ids.</p>
    {caveat_html}
    {split_gate_note_html}
  </header>
  ...
  <section>
    ...
    <p>Main-flow paths are split56-specific and preserve the v6 <code>_64670</code> model/cache provenance. The only v4 path in this report is the explicit diagnostic comparison reference.</p>
    {table(["Stage", "Primary output"], [[esc(name), f"<code>{esc(path)}</code>"] for name, path in stage_rows], "pathlist")}
    {table(["Field", "Value"], [
        ["Source MC cache", "<code>/mnt/mydisk/WCDA_simulation_binned_response_v6_64670</code>"],
        ["Split56 candidate cache", "<code>/mnt/mydisk/WCDA_simulation_binned_response_v6_64670_split56_candidate</code>"],
        ["Run dir", f"<code>{esc(stage_a_meta.get('run_dir'))}</code>"],
        ["Selector", "<code>apply/config/cell_selector_v6_split56_drop4_psfborrow.csv</code>"],
  ...
  <section>
    ...
    <p>Generated by <code>apply/report/build_v6_64670_split56_report.py</code>. Main flow uses split56 v6 outputs; v4 appears only in the explicit comparison section.</p>
  </section>
</main>
</body>
</html>
