...
def main() -> None:
    ...
    expected_figures = [
        ...
        (
            ...
            "Stage D normalized RA-offset observed-count profiles before background subtraction, integrated only over |Dec offset| < 1 deg; gray spans mark each cell's Stage D annulus projected onto the RA-offset axis, and green panels enter the fit",
        ),
        (STAGE_D / "normalized_ra_offset_excess_profiles.png", "Stage D normalized RA-offset excess profiles after background subtraction, integrated only over |Dec offset| < 1 deg; gray spans mark each cell's projected Stage D annulus and green panels enter the fit"),
        (
            STAGE_D / "normalized_dec_offset_counts_profiles.png",
            "Stage D normalized Dec-offset observed-count profiles before background subtraction, integrated only over |RA offset cos(dec)| < 1 deg; gray spans mark each cell's Stage D annulus projected onto the Dec-offset axis, and green panels enter the fit",
        ),
        (STAGE_D / "normalized_dec_offset_excess_profiles.png", "Stage D normalized Dec-offset excess profiles after background subtraction, integrated only over |RA offset cos(dec)| < 1 deg; gray spans mark each cell's projected Stage D annulus and green panels enter the fit"),
