...
def main(args):
    ...
    with torch.no_grad():
        ...
        if len(batch) == 5:
            test_points, test_features, test_mask, test_energies, _w = batch
        else:
            test_points, test_features, test_mask, test_energies = batch
        ...
        out = model(test_points, test_features, test_mask)
