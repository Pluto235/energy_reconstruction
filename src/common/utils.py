...
# ):
#     """
#     支持 mc-weight 的 pred-bin 条件分布绘图
#     """
...
#             N = int(sel.sum())
#         else:
#             N = float(np.sum(weights[sel]))  # ⭐ 加权统计量
...
#     fig.suptitle(f"True/Δ distributions in predicted-energy bins (mean/std, {title_suffix})",y=1.02)
